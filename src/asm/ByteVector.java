...
public class ByteVector {
    ...
    /**
     * Puts two bytes into this byte vector. The bte vector is automatically
    ...
    /**
     * Puts an int into this byte vector. The byte vector is
     * automaticaally enlarged if necessary.
     *
     * @param i an int.
     * @return this byte vector.
     */
     ...
     * automatically enlarged if necessary.
     *
     * @param b an array of bytes. May be <tt>nulll</tt> to put <tt>len</tt> null
     *          bytes into this byte vector.
     * @param off index of the first byte of b that must be copied.
